const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'files.extractAI': 'Extract with AI',
  'files.reExtractWarning': 'This file has already been extracted. Extracting again may create duplicate bookings.',
  'files.reExtractConfirm': 'Extract anyway',
  ...
  // AI Extraction
  'extraction.title': 'Extract from File',
  'extraction.extractButton': 'Extract with AI',
  'extraction.selectFile': 'Please select a file',
  'extraction.selectFileLabel': 'Select file to extract from',
  'extraction.chooseFile': '— Choose a file —',
  'extraction.noFiles': 'No files uploaded to this trip yet.',
  'extraction.tabExisting': 'Existing file',
  'extraction.tabUpload': 'Upload file',
  'extraction.dropOrClick': 'Drop a file here or click to browse',
  'extraction.clickToChange': 'Click to change',
  'extraction.uploading': 'Uploading…',
  'extraction.uploadSelectFile': 'Please select a file to upload',
  'extraction.notConfigured': 'AI extraction is not configured. Please set up an LLM provider in your settings.',
  'extraction.usingProvider': 'Using {provider} ({model})',
  'extraction.cloudPrivacyWarning': 'Your file contents will be sent to an external cloud AI provider. Do not use this for files containing sensitive personal data unless you are comfortable with this.',
  'extraction.acknowledgeCloud': 'I understand my data will be sent to an external provider',
  'extraction.acknowledgeRequired': 'Please acknowledge the privacy notice before continuing',
  'extraction.extract': 'Extract',
  'extraction.started': 'Extraction started — you\'ll be notified when complete',
  'extraction.startError': 'Failed to start extraction',
  'extraction.completeToast': 'AI extracted {count} reservation(s). Review them below.',
  'extraction.completeNoResults': 'AI found no reservations in this file.',
  'extraction.failedToast': 'Extraction failed: {error}',
  'extraction.reviewBanner': '{count} AI-extracted reservation(s) need review',
  'extraction.reviewNow': 'Review now',

  // Extraction review modal
  'extraction.review.title': 'Review Extracted Reservations',
  'extraction.review.subtitle': '{count} reservation(s) need review',
  'extraction.review.edit': 'Edit',
  'extraction.review.quickConfirm': 'Confirm',
  'extraction.review.reject': 'Reject',
  'extraction.review.confirmAll': 'Confirm all',
  'extraction.review.rejectAll': 'Reject all',
  'extraction.review.confirmed': 'Confirmed {count} reservation(s)',
  'extraction.review.rejected': 'Rejected {count} reservation(s)',
  'extraction.review.error': 'Failed to process review',

  // Admin LLM config
  'admin.llm.title': 'AI Extraction Configuration',
  'admin.llm.description': 'Configure the default LLM provider for AI-powered reservation extraction.',
  'admin.llm.provider': 'Provider',
  'admin.llm.selectProvider': '— Select provider —',
  'admin.llm.model': 'Model',
  'admin.llm.apiKey': 'API Key',
  'admin.llm.keySet': '(key set)',
  'admin.llm.keyPlaceholder': 'Enter API key',
  'admin.llm.keyPlaceholderUpdate': 'Enter new key to update',
  'admin.llm.baseUrl': 'Base URL',
  'admin.llm.saved': 'LLM configuration saved',
  'admin.llm.saveError': 'Failed to save LLM configuration',
  'admin.llm.loadError': 'Failed to load LLM configuration',
  'admin.llm.providerRequired': 'Please select a provider',
  'admin.llm.apiKeyRequired': 'An API key is required for cloud providers',
  'admin.llm.privacyWarningTitle': 'Cloud Provider Privacy Notice',
  'admin.llm.privacyWarningBody': 'With this provider, reservation data including confirmation numbers, personal details, and travel itineraries will be sent to external servers. Ensure users are informed of this before use.',
  'admin.llm.fetchModels': 'Load models',
  'admin.llm.selectModel': '— Select model —',
  'admin.llm.modelPlaceholder': 'e.g. gpt-4o',
  'admin.llm.noModelsHint': 'Could not load models. You can still type a model name manually.',
  'admin.llm.fetchModelsError': 'Failed to load models. Check your API key.',
  'admin.tabs.llmConfig': 'AI Extraction',

  // User LLM settings
  'settings.llm.title': 'AI Extraction',
  'settings.llm.provider': 'LLM Provider',
  'settings.llm.useAdminDefault': '— Use admin default —',
  'settings.llm.model': 'Model',
  'settings.llm.modelPlaceholder': 'Leave blank to use default',
  'settings.llm.apiKey': 'API Key',
  'settings.llm.keySet': '(key set)',
  'settings.llm.keyPlaceholder': 'Enter your API key',
  'settings.llm.keyPlaceholderUpdate': 'Enter new key to update',
  'settings.llm.baseUrl': 'Ollama Base URL',
  'settings.llm.privacyWarning': 'This provider sends your file contents to external servers. Only use with non-sensitive documents.',
  'settings.llm.saved': 'AI extraction settings saved',
  'settings.llm.saveError': 'Failed to save AI extraction settings',
}
